...
/** Converts a date input value ("YYYY-MM-DD") to the ISO instant at local 00:00:00. */
...
/** Converts a date input value ("YYYY-MM-DD") to the ISO instant at local 23:59:59. */
